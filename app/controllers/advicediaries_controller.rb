class AdvicediariesController < ApplicationController
  ...
  def choice
    if current_user.plan == 'pln_572790307dd04b525bdd0a155347' || current_user.demo == 'torekadekawaro'
      ...
      # バルクアップ
      @advicemenu_p = Advicemenu.where(group: "P")
      @advicemenu_q = Advicemenu.where(group: "Q")
      @advicemenu_r = Advicemenu.where(group: "R")
      @advicemenu_s = Advicemenu.where(group: "S")
      @advicemenu_t = Advicemenu.where(group: "T")
      @advicemenu_u = Advicemenu.where(group: "U")
      @advicemenu_v = Advicemenu.where(group: "V")
      @advicemenu_w = Advicemenu.where(group: "W")
      @advicemenu_x = Advicemenu.where(group: "X")
      @advicemenu_y = Advicemenu.where(group: "Y")
      @advicemenu_z = Advicemenu.where(group: "Z")
      @advicemenu_aa = Advicemenu.where(group: "AA")
      @advicemenu_ab = Advicemenu.where(group: "AB")
      @advicemenu_ac = Advicemenu.where(group: "AC")
      @advicemenu_ad = Advicemenu.where(group: "AD")
      #美尻
      @advicemenu_ae = Advicemenu.where(group: "AE")
      @advicemenu_af = Advicemenu.where(group: "AF")
      @advicemenu_ag = Advicemenu.where(group: "AG")
      @advicemenu_ah = Advicemenu.where(group: "AH")
      @advicemenu_ai = Advicemenu.where(group: "AI")
      @advicemenu_aj = Advicemenu.where(group: "AJ")
      #美女
      @advicemenu_ak = Advicemenu.where(group: "AK")
      @advicemenu_al = Advicemenu.where(group: "AL")
      @advicemenu_am = Advicemenu.where(group: "AM")
      @advicemenu_an = Advicemenu.where(group: "AN")
      @advicemenu_ao = Advicemenu.where(group: "AO")
      @advicemenu_ap = Advicemenu.where(group: "AP")
      @advicemenu_aq = Advicemenu.where(group: "AQ")
      @advicemenu_ar = Advicemenu.where(group: "AR")
      @advicemenu_as = Advicemenu.where(group: "AS")
      @advicemenu_at = Advicemenu.where(group: "AT")
    else
      redirect_to controller: :dashboards, action: :index
    end
  end
